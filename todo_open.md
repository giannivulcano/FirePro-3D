...
- [ ] [type:bug] HALO picks the wrong item when zoomed in (ranks Z-first by bbox-centre distance; world-unit hit width) [P2] [subject:UX]
...
- [ ] [type:bug] Drag-select is extremely slow on large drawings (Ctrl+A is not) [P2] [subject:UX]
...
- [ ] [type:bug] Elevation HALO hover misses the label text inside a gridline/datum bubble [P3] [subject:UX] [done:2026-09-24]
...
- [ ] [type:maint] Dedicated rubber-band / HALO band colour tokens [P3] [subject:UX] [done:2026-09-24]
