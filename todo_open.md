...
- [ ] [type:feature] Arc (and other primitive) vertex grips edit geometry instead of moving the whole item [P1] [subject:CAD]
...
- [ ] [type:feature] Remove the rotate knob from 2D primitives and multi-selections of primitives [P1] [subject:UX]
...
- [ ] [type:feature] Rectangle placement rethink — base point, then angle + 1st dimension, then 2nd dimension (ellipse-like) [P1] [subject:CAD]
...
- [ ] [type:bug] Start-Point arc variant shows "Pick start angle point" at step 1 (should ask for the centre) [P3] [subject:UX]
