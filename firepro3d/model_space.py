...
class Model_Space(SceneIOMixin, QGraphicsScene):
    ...
    # --- async DXF worker bridge: only _dxf_import_params still has a scene-side
    # reference (_refresh_underlay stores DWG cleanup metadata on it); the
    # worker/progress refs live wholly on the controller now (C2a). ---
    @property
