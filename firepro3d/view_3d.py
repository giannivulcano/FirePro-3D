...
class View3D(QWidget):
    ...
    def _extract_geometry_2d(self):
        # Loose 2D primitives no longer exist in the plan scene (containment
        # C1/C3) — they are Block-definition-local and level-less, so there is
        # nothing to project into 3D. Block-instance 3D projection is a deferred
        # Feature-representation concern (C3 grill fork B). Clear any stale
        # construction actors and return.
