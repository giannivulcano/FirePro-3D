...
- [ ] Replace QDoubleSpinBox with QLineEdit in import dialog — Scale value, Angle, Base X/Y fields use spinners; project convention is QLineEdit + format_length/parse_dimension. `dxf_preview_dialog.py` [type:Task] [P2] [subject:CAD]
