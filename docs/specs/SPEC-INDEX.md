...
| **Block system** (definition/instance flyweight, library, Manager, browser, placement) | `specs/block-system.md` | `block_definition.py`, `block_instance.py`, `block_library.py`, `block_manager.py`, `block_browser.py`, `app_data.py`, `model_space.py` (registry + placement + make-from-selection), `scene_io.py` (embed), `main.py` (ribbon/dock) | **proposal** (v1 unbuilt — flyweight def/instance + 2-tier `.fpdb` library + Manager; retires `BlockItem`; Editor/import/attributes/paper-space = v2) |
